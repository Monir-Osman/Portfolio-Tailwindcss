...
function Header() {
  ...
  return (
    <section
      id="home"
      className="w-full flex justify-center items-center bg-gradient-to-tr from-black to-slate-900 h-screen"
    >
      <div className="text-center p-5 md:p-12 lg:p-20 mb-20">
        <Fade bottom cascade>
          <h1 className="text-4xl md:text-6xl lg:text-8xl text-white font-sriracha mb-10">
            I'm Monir Osmani
          </h1>
        </Fade>
